...
void usage() {
   std::cerr << "./data_generator <set_length> <length>" << std::endl;
   std::cerr << "Generates <set_length> rows. Each row follows [x array]" << std::endl;
   std::cerr << "where \"x\" is a value in the array and \"array\" is <lenght> length" << std::endl;
   exit(1);
}
